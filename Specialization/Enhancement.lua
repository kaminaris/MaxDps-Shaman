...
function Enhancement:aoe()
    ...
    if (MaxDps:CheckSpellUsable(classtable.Tempest, 'Tempest')) and (not buff[classtable.ArcDischargeBuff].up >= 1 and ( ( buff[classtable.MaelstromWeaponBuff].count == 10 and not (talents[classtable.RagingMaelstrom] and true or false) ) or ( buff[classtable.MaelstromWeaponBuff].count >= 9 ) ) or ( buff[classtable.MaelstromWeaponBuff].count >= 5 and ( C_Spell.GetSpellCastCount(classtable.Tempest) >30 ) )) and cooldown[classtable.Tempest].ready then
